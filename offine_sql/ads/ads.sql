...
group by recent_days,channel,ds;
...
from
    (
        ...
        where ds=${d}
          and login_date_last=date_add( '20250920',-7)
    )churn
        join
    (
        select
...
select '20250920' ds,
       ...
       datediff('2025-09-20', login_date_first) retention_day,
       sum(if(login_date_last = '20250920', 1, 0)) retention_count,
       count(*) new_user_count,
       cast(sum(if(login_date_last = '20250920', 1, 0)) / count(*) * 100 as decimal(16, 2)) retention_rate
from (
         select user_id,
                login_date_last,
                login_date_first
...
select '20250920' ds,
       recent_days,
       sum(if(login_date_first >= date_add('20250920', -recent_days + 1), 1, 0)) new_user_count,
...
where ds in ('9999-12-31','20250920')
  and payment_date_id='20250920';
