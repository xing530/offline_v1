...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_sku_full/'
...
-- 2. 先避开本地模式，日志会走 YARN，也方便后面用 yarn logs 查看
set hive.exec.mode.local.auto=false;
...
insert overwrite table  realtime_v1_hive.dim_sku_full partition(ds='20250917')
select
    sku.id,
    sku.price,
    sku.sku_name,
...
select count(*) from realtime_v1_hive.ods_sku_info_full where ds='20250917';
select * from ods_sku_info_full;
select count(*) from ods_sku_attr_value_full where ds='20250917';
select count(*) from ods_sku_sale_attr_value_full where ds='20250917';
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_coupon/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_activity/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_province/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_promotion_pos/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_promotion_refer/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_date/'
    TBLPROPERTIES ('orc.compress' = 'snappy');
...
(
    ...
    LOCATION '/user/hive/warehouse/dim/dim_user_zip/'
    TBLPROPERTIES ('orc.compress' = 'snappy');